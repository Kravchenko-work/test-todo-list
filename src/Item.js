...
class Item extends Component {
	constructor(props) {
		...
		this.state = {
			classCheck: (props.check == "true" ? "check__label" : "check__label check__label--true"),
		};
		...
		return (
			<div className="item">
				<div className="item__elem check">
					<label htmlFor="check__input" className={this.state.classCheck} onClick={updateDataOnClickCheck}></label>
					<input type="checkbox" id="check__input" className="check__input" />
				</div>
				<div className="item__elem text">
					<input type="text" className="text__input" defaultValue={this.props.text} onChange={UpdateDataOnChangeInput} />
				</div>
